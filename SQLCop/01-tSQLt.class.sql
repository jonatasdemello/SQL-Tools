...
GO
CREATE FUNCTION tSQLt.Private_Bin2Hex
(
	@vb VARBINARY(MAX)
)
RETURNS TABLE
...
CREATE FUNCTION tSQLt.Private_QuoteClassNameForNewTestClass
(
	@ClassName NVARCHAR(MAX)
)
...
----------------------------------------------------------------------
CREATE FUNCTION tSQLt.Private_GetLastTestNameIfNotProvided 
(
	@TestName NVARCHAR(MAX)
)
RETURNS NVARCHAR(MAX)
...
CREATE FUNCTION tSQLt.Private_GetCleanSchemaName
(
...
CREATE FUNCTION tSQLt.Private_GetCleanObjectName
(
	@ObjectName NVARCHAR(MAX)
)
RETURNS NVARCHAR(MAX)
...
CREATE FUNCTION tSQLt.Private_GetOriginalTableName
(
	@SchemaName NVARCHAR(MAX), 
	@TableName NVARCHAR(MAX)
) --DELETE!!!
...
CREATE FUNCTION tSQLt.Private_GetOriginalTableInfo
(
	@TableObjectId INT
)
RETURNS TABLE
...
CREATE FUNCTION tSQLt.Private_GetQuotedFullName
(
	@Objectid INT
)
...
CREATE FUNCTION tSQLt.Private_GetSchemaId
(
	@SchemaName NVARCHAR(MAX)
)
RETURNS INT
...
CREATE FUNCTION tSQLt.Private_IsTestClass
(
...
CREATE FUNCTION tSQLt.Private_ResolveSchemaName
(
	@Name NVARCHAR(MAX)
)
RETURNS TABLE 
...
CREATE FUNCTION tSQLt.Private_ResolveObjectName
(
	@Name NVARCHAR(MAX))
RETURNS TABLE 
AS
...
CREATE FUNCTION tSQLt.Private_ResolveName
(
	@Name NVARCHAR(MAX)
)
RETURNS TABLE 
...
CREATE PROCEDURE tSQLt.LogCapturedOutput 
	@text NVARCHAR(MAX)
AS
BEGIN
...
AUTHORIZATION [dbo] 
FROM
	
	WITH 
	PERMISSION_SET = SAFE;
GO
...
CREATE FUNCTION tSQLt.Private_GetConstraintType
(
	@TableObjectId INT, 
	@ConstraintName NVARCHAR(MAX)
)
...
GO
CREATE FUNCTION tSQLt.Private_GetDataTypeOrComputedColumnDefinition
(
	@UserTypeId INT, 
	@MaxLength INT, 
	@Precision INT, 
...
CREATE FUNCTION tSQLt.Private_GetIdentityDefinition
(
	@ObjectId INT, 
	@ColumnId INT, 
	@ReturnDetails BIT
...
GO
CREATE FUNCTION tSQLt.Private_GetDefaultConstraintDefinition
(
	@ObjectId INT, 
	@ColumnId INT, 
	@ReturnDetails BIT
...
GO
CREATE FUNCTION tSQLt.Private_GetCommaSeparatedColumnList
(
	@Table NVARCHAR(MAX), 
	@ExcludeColumn NVARCHAR(MAX)
)
RETURNS NVARCHAR(MAX)
AS 
BEGIN
...
CREATE FUNCTION tSQLt.Private_SqlVariantFormatter
(
	@Value SQL_VARIANT
)
RETURNS NVARCHAR(MAX)
