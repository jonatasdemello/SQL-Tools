...
-------------------------------------------------------------------------------------------------------------------------------
Get-DbaDbTable -SqlInstance 192.168.11.49 -Database CMS_Stage -Table Study.MajorInfo | Copy-DbaDbTableData -DestinationDatabase CMS_Dev -Table Study.MajorInfo -KeepIdentity -Truncate
